...
const MotionEffect = () => {
  return (
    <section className='w-full h-20 flex justify-between items-center pt-4 px-4 lg:px-20'>
      ...
      <div>
        <button className='lg:bg-white lg:mr-40 outfit w-32 h-10 rounded text-black p-2 text-center hover:bg-black hover:text-white hover:border-white hover:border-2'>
          Purchase Now
        </button>
      </div>
    </section>
